...
@RestController
public class TipoOperacionCreditoControllers {

	
	@Autowired
	private TipoOperacionCreditoService  tipoProductosService;
	
	@GetMapping
	public Mono<ResponseEntity<Flux<TipoOperacionCredito>>> findAll() 
	{
		return Mono.just(
				ResponseEntity
				.ok()
	...
	@GetMapping("/{id}")
	public Mono<ResponseEntity<TipoOperacionCredito>> viewId(@PathVariable String id){
	...
	@PutMapping
	public Mono<TipoOperacionCredito> updateProducto(@RequestBody TipoOperacionCredito tipoProducto)
	{
	...
	@PostMapping
	public Mono<TipoOperacionCredito> saveTipoProducto(@RequestBody TipoOperacionCredito tipoProducto)
	{
		return tipoProductosService.saveTipoProducto(tipoProducto);
	}	
